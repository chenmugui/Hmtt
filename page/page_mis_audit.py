...
class PageMisAudit(WebBase):
    ...
    def page_click_info_manage(self):
        ...
        sleep(1)
        # 2. 点击信息管理
        self.base_click(uiAutoTestHmtt.page.mis_info_manage)
    ...
    def page_click_content_audit(self):
        ...
        sleep(1)
        # 2. 点击内容审核
        self.base_click(uiAutoTestHmtt.page.mis_content_audit)

    # 3. 输入文章标题
    def page_input_title(self, title):
        self.base_input(uiAutoTestHmtt.page.mis_title, title)

    # 4. 输入文章频道
    def page_input_channel(self, channel):
        self.base_input(uiAutoTestHmtt.page.mis_channel, channel)
    ...
    def page_click_find(self):
        # 1. 点击查询按钮
        self.base_click(uiAutoTestHmtt.page.mis_find)
        # 2. 暂停时间
        sleep(2)

    # 7. 获取文章id
    def page_get_article_id(self):
        return self.base_get_text(uiAutoTestHmtt.page.mis_article_id)

    # 8. 点击通过
    def page_click_pass_btn(self):
        self.base_click(uiAutoTestHmtt.page.mis_pass)
    ...
    def page_click_confirm_pass(self):
        ...
        sleep(1)
        # 点击确认
        self.base_click(uiAutoTestHmtt.page.mis_confirm_pass)
