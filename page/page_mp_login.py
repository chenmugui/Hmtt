...
class PageMpLogin(WebBase):
    ...
    def page_input_username(self, username):
        # 调用父类中输入方法
        self.base_input(uiAutoTestHmtt.page.mp_username, username)

    # 输入验证码
    def page_input_code(self, code):
        # 调用父类中输入方法
        self.base_input(uiAutoTestHmtt.page.mp_code, code)

    # 点击登录按钮
    def page_click_login_btn(self):
        sleep(1)
        # 调用父类中点击方法
        self.base_click(uiAutoTestHmtt.page.mp_login_btn)
