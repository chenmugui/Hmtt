...
class PageMisLogin(WebBase):
    ...
    def page_input_username(self, username):
        self.base_input(uiAutoTestHmtt.page.mis_username, username)

    # 2. 输入密码
    def page_input_pwd(self, pwd):
        self.base_input(uiAutoTestHmtt.page.mis_pwd, pwd)
    ...
    def page_click_login_btn(self):
        ...
        # 2. 调用点击操作
        self.base_click(uiAutoTestHmtt.page.mis_login_btn)

    # 4. 获取昵称封装
    def page_get_nickname(self):
        return self.base_get_text(uiAutoTestHmtt.page.mis_nickname)
