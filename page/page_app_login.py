...
class PageAppLogin(AppBase):
    ...
    def page_input_phone(self, phone):
        self.base_input(uiAutoTestHmtt.page.app_phone, phone)

    # 2. 输入验证码
    def page_input_code(self, code):
        self.base_input(uiAutoTestHmtt.page.app_code, code)

    # 3. 点击登录按钮
    def page_click_login_btn(self):
        # 建议等待1-2秒
        sleep(2)
        self.base_click(uiAutoTestHmtt.page.app_login_btn)

    # 4. 判断页面是否存在 我的菜单
    def page_is_login_success(self):
        return self.app_base_is_exist(uiAutoTestHmtt.page.app_me)
