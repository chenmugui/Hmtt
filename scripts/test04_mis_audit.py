...
class TestMisAudit:
    ...
    def setup_class(self):
        # 1. 获取driver
        driver = GetDriver.get_web_driver(uiAutoTestHmtt.page.url_mis)
        # 2. 获取统一入口类对象
    ...
    # 3. 审核文章业务测试方法
    def test_mis_audit(self, title=uiAutoTestHmtt.page.title, channel=uiAutoTestHmtt.page.channle):
        # 调用审核文章业务方法
